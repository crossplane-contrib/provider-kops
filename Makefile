...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Kops CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Kops controllers
...
# This target prepares repo for your provider by replacing all "kops"
